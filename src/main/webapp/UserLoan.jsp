            ...
            <ul class="navbar-nav  ">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="Payment.jsp">Registrar <span class="sr-only">(current)</span></a>
                  <a class="dropdown-item" href="Payment.jsp">Other Services</a>
                </div>
              </li>
              <li class="nav-item">
    ...
    <div class="service_container">
      <div class="container ">
        <div class="heading_container heading_center">
          <h2>
            Our <span>Loan Services</span>
          </h2>
          <p>
           	There are three fundamental Service Provide by ASTU BANK
          </p>
        </div>
        <div class="row">
          <div class="col-md-4 ">
            <div class="box ">
              ...
              <div class="detail-box">
                ...
                <button class="btn btn-primary apply-btn mt-30">
                  Read More
                </button>
              </div>
            </div>
        ...
        <div class="col-md-6 col-lg-2 mx-auto info_col">
          <div class="info_link_box">
            ...
            <div class="info_links">
              ...
              <a class="" href="UserTransfer.jsp">
                About
              </a>
              <a class="" href="Payment.jsp">
                Payment
              </a>
              <a class="" href="Transaction.jsp">
                Transaction
              </a>
              <a class="" href="UserLoan.jsp">
                Loan
              </a>
            </div>
          </div>
