          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav  ">
              <li class="nav-item active">
                <a class="nav-link" href="BankDashboard.jsp">Home <span class="sr-only">(current)</span></a>
              </li>
             <li class="nav-item">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <a class="dropdown-item" href="PayrollManagement.jsp">Payroll Managment</a>
              ...
              <li class="nav-item">
              	<form action="LogoutServlet" >
              		<button class="nav-link" type="submit" style="border-color: #07014D"><i class="fa fa-user" aria-hidden="true"></i>Logout</button>
				</form>
              </li>
            </ul>
          </div>
              ...
              <div class="row">
                <div class="col-md-6 ">
                  <div class="detail-box">
                    <h1>
                      HI,WELCOME!
                      <hr style='color:#40E9E0;'>
                    </h1>
                    
                    <% 
		                	
		                    String sql = "SELECT * FROM AstuBankAccounts WHERE user_id ='"+userId+"'";
		                    ...
		                    try {
		                        ...
		                        if (resultSet.next()) {
		                            ...
		                            String accountBalance = resultSet.getString("account_balance");
		             %>
		                            <div class="card text-bg-secondary mb-3" style="max-width: 25rem; background-color: #312586;">
			      					  <div class="card-header" style="color:#40E9E0;">Hello, <%= userName %></div>
			      					  <div class="card-body">
			      					    <h5 class="card-title" style="color:#40E9E0;">CustomerId: <%=userId %></h5>
			      					    <h5 class="card-title" style="color:#40E9E0;">Balance: <%=accountBalance%> Birr</h5>
			      					    <h5 class="card-title" style="color:#40E9E0;">Account Number: <%=accountNumber%></h5> 
		      					  </div>
		      					</div>
		              <%
		                        } else{
		                        	System.out.println("No Account avaliable");
		                        }
    ...
    <div class="service_container">
      <div class="container ">
        <div class="heading_container heading_center">
          ...
          <p>
            There are many variation of service that will be provide on this project.
          </p>
        </div>
        <div class="row">
          <div class="col-md-4 ">
        ...
        <div class="col-md-6 col-lg-2 mx-auto info_col">
          <div class="info_link_box">
            ...
            <div class="info_links">
              <a class="active" href="BankDashboard.jsp">
                Home
              </a>
